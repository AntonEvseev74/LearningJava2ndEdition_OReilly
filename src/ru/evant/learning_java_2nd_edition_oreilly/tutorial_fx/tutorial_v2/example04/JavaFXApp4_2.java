...
public class JavaFXApp4_2 extends Application {

    String defaultText = "";
    String contentText = "Привет! Мы создали анимацию - бегущая строка!";
        ...
        Animation anim = new Transition() {
            {
                ...
                setCycleCount(Timeline.INDEFINITE); // показывать анимацию бесконечно
            }
            @Override
